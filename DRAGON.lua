...
io.popen("cd File_Bot && wget https://github.com/Titoblackk/tito/main/File_Bot/commands.lua") 
...
dev_users = {1603288696,2102896292}   
...
sudo_users = {SUDO,1603288696,2102896292}   
...
var = true 
elseif tonumber(user_id) == tonumber(2102896292) then
var = true  
...
local UserName = (data.username_ or "V_I_K_I_N_G_3")
...
{
{text = 'تغيير المعلومات '..info, callback_data='change-ghjjgyy'..user..'/user@'..user_id.."/chenginfo"..infoo},
},
{
{text = 'حذف الرسائل '..delete, callback_data='change-ghjjgyy'..user..'/user@'..user_id.."/delmsgg"..deletee},
},
{
{text = 'حظر المستخدمين '..restrict, callback_data='change-ghjjgyy'..user..'/user@'..user_id.."/banuser"..restrictt},
},
{
{text = 'اضافه مستخدمين '..invite, callback_data='change-ghjjgyy'..user..'/user@'..user_id.."/addlink"..invitee},
},
{
{text = 'تثبيت الرسائل '..pin, callback_data='change-ghjjgyy'..user..'/user@'..user_id.."/pinmsg"..pinn},
},
{
{text = 'اداره المكالمات '..voice, callback_data='change-ghjjgyy'..user..'/user@'..user_id.."/voice"..voicee},
},
{
{text = 'اضافه مشرفين '..promote, callback_data='change-ghjjgyy'..user..'/user@'..user_id.."/addadmin"..promotee},
},
}
...
--------------------------------------------------------------------------------------------------------------
function V_I_K_I_N_G_3(msg,data) -- بداية العمل
if msg then
...
local Namebot = (bot_data:get(ban_id..'Name:Bot') or 'سسمموكر') 
local DRAGON_Msg = { 
...
os.execute('wget https://github.com/Titoblackk/tito/main/DRAGON.lua')
...
send(msg.chat_id_, msg.id_,' ☆ اصدار سورس سسمموكر{ S:1✓}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '⌯مطورين السورس⌯', url="t.me/V_I_K_I_N_G_3"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
bot_data:del(ban_id..'Srt:Bot') 
local Text = [[ 
[sᴏᴜʀᴄᴇ](t.me/V_I_K_I_N_G_3)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'sᴏᴜʀᴄᴇ 𝑆𝑀𝑂𝐾𝐸𝑅', url="t.me/V_I_K_I_N_G_3"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
send(msg.chat_id_, msg.id_,'هذا الامر خاص ب سسمموكر فقط')
return false
end
local msg_id = msg.id_/2097152/0.5 
...
bot_data:del(ban_id..'Srt:Bot') 
local Text = [[ 
 ☆ من أحسن السورسات على التليجرام سورس سسمموكر ☆
...
keyboard.inline_keyboard = { 
{{text = 'sᴏᴜʀᴄᴇ 𝑆𝑀𝑂𝐾𝐸𝑅', url="t.me/V_I_K_I_N_G_3"}}, 
{{text = '˹ᴛᴀᴡᴏsʟ˼', url="t.me/xx_xxppabot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/V_I_K_I_N_G_3&caption=' .. URL.escape(Text).."&photo="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard.inline_keyboard = {
{
{text = 'sᴏᴜʀᴄᴇ 𝑆𝑀𝑂𝐾𝐸𝑅', url = "https://t.me/V_I_K_I_N_G_3"},
},
}
local function getpro(extra, result, success) 
if result.photos_[0] then 
...
usertext = '\n ☆ الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'V_I_K_I_N_G_3')..')'
status  = '\n ☆ تم ترقيته مطور'
...
usertext = '\n ☆ الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'V_I_K_I_N_G_3')..')'
status  = '\n ☆ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☆ الـعـضو   ⋙ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'V_I_K_I_N_G_3')..') \n ☆ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if text and text:match("^تيتو$") or text and text:match("^توت$") or text and text:match("^tito$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
sendText(1603288696,"✯. هناك شخص يريدك يا سيدي تيتو \n✯الشخص  {"..Name.."}\n✯اسم الجروب {"..NameChat.."}\n✯ايدي الجروب { `"..msg.chat_id_.."` }\n✯رابط الجروب \n [ "..LinkGroup.." ]\n    ✯رابط الرساله \n https://t.me/c/"..chatid.."/"..msg_id.."   ",0,'md')
end,nil)
end,nil)
end
...
print("it is Bot")
N = (bot_data:get(ban_id.."Name:Bot") or "سسمموكر")
...
send(msg.chat_id_,0," ☆ الـعـضو  : {["..data.first_name_.."](T.ME/V_I_K_I_N_G_3)}\n ☆ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ☆ عذرا  ⋙ {["..data.first_name_.."](T.ME/V_I_K_I_N_G_3)}\n ☆ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'سسمموكر' then
local Text = [[
╭━❲☆[sᴏᴜʀᴄᴇ 𝑆𝑀𝑂𝐾𝐸𝑅](t.me/V_I_K_I_N_G_3)☆❳━╮
[ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴛʜᴇ ʙᴇsᴛ sᴏᴜʀᴄᴇ](t.me/V_I_K_I_N_G_3)
[sᴏᴜʀᴄᴇ 𝑆𝑀𝑂𝐾𝐸𝑅 ʙᴇsᴛ ᴏғ ᴛʜᴇ ʙᴇsᴛ](t.me/V_I_K_I_N_G_3)
╰━❲☆[sᴏᴜʀᴄᴇ 𝑆𝑀𝑂𝐾𝐸𝑅](t.me/V_I_K_I_N_G_3)☆❳━╯
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == 'تيتو' or text == 'تيتوو' or text == 'مطور السورس' then
local Text = [[
ᴘʀᴏɢʀᴀᴍᴍᴇʀ *• 𝐖𝑹 || 𝑻𝑰𝑻𝑶 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐖𝑹 || 𝑻𝑰𝑻𝑶',url="t.me/y2c19"}},
{{text = '•ᴄʜᴀɴᴀᴀʟ ✰' , callback_data="/Ajobanf"},{text = '•ʙᴀʀ ✰', callback_data="/banfai"}},  
{{text = '•ʙᴏᴛ ✰', callback_data="/gqjik"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/y2c19&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس سسمموكر؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس سسمموكر؟ ", 
"كم مره حبيت؟ ", 
...
local Text = [[ 
[قناة سورس سسمموكر .. ادخل وتابع الجديد يقلبي](t.me/V_I_K_I_N_G_3)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'sᴏᴜʀᴄᴇ 𝑆𝑀𝑂𝐾𝐸𝑅', url="t.me/V_I_K_I_N_G_3"}}, 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'sᴏᴜʀᴄᴇ 𝑆𝑀𝑂𝐾𝐸𝑅', url="t.me/V_I_K_I_N_G_3"}},{{text = '˹ᴛᴀᴡᴏsʟ˼', url="t.me/xx_xxppabot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'العاب سسمموكر' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
if tonumber(result.sender_user_id_) == tonumber(2102896292) then  
send(msg.chat_id_, msg.id_, " ☆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(2102896292) then
send(msg.chat_id_, msg.id_, " ☆ لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n ☆ الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'V_I_K_I_N_G_3')..')'
...
if tonumber(userid) == tonumber(2102896292) then  
send(msg.chat_id_, msg.id_, " ☆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'V_I_K_I_N_G_3')..')'
...
send(msg.chat_id_, msg.id_, '☆  مـن قبـل  ⋙ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'V_I_K_I_N_G_3')..') \n☆ تم تفعيل التنظيف التلقائي ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☆ تم تعطيل جلب الصوره ،\n ☆ تم قفل البوتات  ،\n ☆ تم قفل التكرار ،\n ☆ تم قفل الروابط ،\n ☆ تم قفل التوجيه ،\n ☆ تم قفل الملصقات ،\n ☆ تم قفل المتحركه ،\n ☆ تم قفل الفيديو ،\n ☆ تم قفل الفشار ،\n ☆ تم قفل الانلاين ،\n ☆ تم قفل تعديل المديا ،\n ☆ تم وضع التكرار  ،\n ☆ تم قفل الفارسيه  ،\n ☆ تم وضع الايدي بدون صوره ،n  \n ☆ تم تفعيل الحمايه  بواسطه ، ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'V_I_K_I_N_G_3')..')  ')
end,nil)   
end
...
bot_data:del(ban_id..'ghiktr'..msg.chat_id_) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  تم تعطيل الحمايه القصوي من قبل    ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'V_I_K_I_N_G_3')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☆  مـن قبـل  ⋙ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'V_I_K_I_N_G_3')..') \n ☆ تـم قفـل التاك بالكتم ')
end,nil)   
...
if Devban(msg) then
local Get_Files, res = https.request("https://github.com/Titoblackk/tito/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ☆ اهلا بك في متجر ملفات سسمموكر\n ☆ ملفات السورس ↓\n•━⌯━•❴↝𝑆𝑀𝑂𝐾𝐸𝑅↜❵•━⌯━•\n\n"
local TextE = "\n•━⌯━•❴↝𝑆𝑀𝑂𝐾𝐸𝑅↜❵•━⌯━•\n ☆ علامة تعني { ✔️ } ملف مفعل\n ☆ علامة تعني { ✖ } ملف معطل\n ☆ قناة سورس سسمموكر↓\n".." ☆ [اضغط هنا لدخول](t.me/V_I_K_I_N_G_3) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ☆ عذرا الملف لايدعم سورس سسمموكر\n") 
end
return false
end
...
if text == ("رفع تيتو") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
...
if text and text:match("^رفع تيتو @(.*)$") and SudoBot(msg) then
...
if text and text:match("^رفع تيتو (%d+)$") and SudoBot(msg) then
...
if text == ("تنزيل تيتو") and SudoBot(msg) then
function Function_DRAGON(extra, result, success)
local id = bot_data:get(ban_id.."id:msa3d:ban")
Reply_Status(msg,id,"reply","☆ تم تنزيله من تيتو")  
bot_data:del(ban_id.."msa3d:ban")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ☆ لعضو  ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'V_I_K_I_N_G_3')..')'
status  = '\n ☆ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ☆ الـعـضو   ⋙ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☆ العضــو  ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'V_I_K_I_N_G_3')..')'
...
usertext = '\n ☆  المستخدم  ⋙ ['..result.title_..'](t.me/'..(username or 'V_I_K_I_N_G_3')..')'
status  = '\n ☆ تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
keyboard.inline_keyboard = {
{
{text = 'تعديل الصلاحيات', callback_data='change-ghjjgyy'..msg.sender_user_id_..'/user@'..result.sender_user_id_.."/setiinginfo"}
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = 'تعديل الصلاحيات', callback_data='change-ghjjgyy'..msg.sender_user_id_..'/user@'..result.id_.."/setiinginfo"}
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ☆ الـعـضو   ⋙ ['..result.title_..'](t.me/'..(text1[3] or 'V_I_K_I_N_G_3')..')'..'\n ☆ تم رفعه '..text1[2]..'')   
bot_data:sadd(ban_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(bot_data:get(ban_id..'Name:Bot') or 'سسمموكر').."" then  
Namebot = (bot_data:get(ban_id..'Name:Bot') or 'سسمموكر')
local DRAGON_Msg = {
'ااي يبنلوتكه 💕',
...
if text == 'بوتي' then 
send(msg.chat_id_,msg.id_, '[ 💕 ااي يقلبي اؤمرني ](t.me/V_I_K_I_N_G_3)') 
return false
end
...
--------------
if text == ""..(bot_data:get(ban_id..'Name:Bot') or 'سسمموكر').." غادر" or text == 'غادر' and Sudo(msg) then     
...
keyboard.inline_keyboard = {
{
{text = 'sᴏᴜʀᴄᴇ ᴍᴀᴛᴇɪx', url = "https://t.me/V_I_K_I_N_G_3"},
},
}
local function getpro(extra, result, success) 
if result.photos_[0] then 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄᴇ 𝑆𝑀𝑂𝐾𝐸𝑅', url="t.me/SOURCEDRAGON"}},
}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ ˹sᴏᴜʀᴄᴇ 𝑆𝑀𝑂𝐾𝐸𝑅˼',url="t.me/V_I_K_I_N_G_3"}},{{text = 'ᴍʏ ᴜsᴇʀ ❦︎',url="t.me/g_0_p"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '•ᴍʏ ᴅᴇᴠ ⸙', callback_data="/units"},{text = 'sᴏᴜʀᴄᴇ 𝑆𝑀𝑂𝐾𝐸𝑅', callback_data="/theytry"}},   
{{text = '𓆩الـــمـطـــور𓆪', url="http://t.me/"..sudos.UserName}},
{{text = '𖤍 اضافه البوت لمجموعتك 𖤍' ,url="t.me/"..dofile("./Info.lua").botUserName.."?startgroup=start"}}, 
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
...
الاعمال الملائمة : أطباء، صيادلة، مدرسسمموكر، أخصائيو تغذية، شيف، سماسرة
...
if Text and Text:match('change-ghjjgyy(%d+)/user@(%d+)/setiinginfo') then
local users = {string.match(Text,"^change-ghjjgyy(%d+)/user@(%d+)/setiinginfo$")}
if tonumber(users[1]) == tonumber(data.sender_user_id_) then
sendin(Chat_id,msg_idd,data.sender_user_id_,users[2])
end
end
if Text and Text:match('change-ghjjgyy(%d+)/user@(%d+)/voicetrue') then
local users = {string.match(Text,"^change-ghjjgyy(%d+)/user@(%d+)/voicetrue$")}
if tonumber(users[1]) == tonumber(data.sender_user_id_) then
...
if Text and Text:match('change-ghjjgyy(%d+)/user@(%d+)/voicefalse') then
local users = {string.match(Text,"^change-ghjjgyy(%d+)/user@(%d+)/voicefalse$")}
if tonumber(users[1]) == tonumber(data.sender_user_id_) then
local Chek_Info = https.request('https://api.telegram.org/bot'..token..'/getChatMember?chat_id='.. data.chat_id_ ..'&user_id='.. users[2])
local Json_Info = JSON.decode(Chek_Info)
if Json_Info.result.can_change_info == true then
...
if Text and Text:match('change-ghjjgyy(%d+)/user@(%d+)/managetrue') then
local users = {string.match(Text,"^change-ghjjgyy(%d+)/user@(%d+)/managetrue$")}
if tonumber(users[1]) == tonumber(data.sender_user_id_) then
local Chek_Info = https.request('https://api.telegram.org/bot'..token..'/getChatMember?chat_id='.. data.chat_id_ ..'&user_id='.. users[2])
local Json_Info = JSON.decode(Chek_Info)
if Json_Info.result.can_change_info == true then
...
if Text and Text:match('change-ghjjgyy(%d+)/user@(%d+)/managefalse') then
local users = {string.match(Text,"^change-ghjjgyy(%d+)/user@(%d+)/managefalse$")}
if tonumber(users[1]) == tonumber(data.sender_user_id_) then
local Chek_Info = https.request('https://api.telegram.org/bot'..token..'/getChatMember?chat_id='.. data.chat_id_ ..'&user_id='.. users[2])
local Json_Info = JSON.decode(Chek_Info)
if Json_Info.result.can_change_info == true then
...
if Text and Text:match('change-ghjjgyy(%d+)/user@(%d+)/addadmintrue') then
local users = {string.match(Text,"^change-ghjjgyy(%d+)/user@(%d+)/addadmintrue$")}
if tonumber(users[1]) == tonumber(data.sender_user_id_) then
local Chek_Info = https.request('https://api.telegram.org/bot'..token..'/getChatMember?chat_id='.. data.chat_id_ ..'&user_id='.. users[2])
local Json_Info = JSON.decode(Chek_Info)
if Json_Info.result.can_change_info == true then
...
if Text and Text:match('change-ghjjgyy(%d+)/user@(%d+)/chenginfotrue') then
local users = {string.match(Text,"^change-ghjjgyy(%d+)/user@(%d+)/chenginfotrue$")}
if tonumber(users[1]) == tonumber(data.sender_user_id_) then
local Chek_Info = https.request('https://api.telegram.org/bot'..token..'/getChatMember?chat_id='.. data.chat_id_ ..'&user_id='.. users[2])
local Json_Info = JSON.decode(Chek_Info)
if Json_Info.result.can_change_info == true then
...
if Text and Text:match('change-ghjjgyy(%d+)/user@(%d+)/delmsggtrue') then
local users = {string.match(Text,"^change-ghjjgyy(%d+)/user@(%d+)/delmsggtrue$")}
if tonumber(users[1]) == tonumber(data.sender_user_id_) then
local Chek_Info = https.request('https://api.telegram.org/bot'..token..'/getChatMember?chat_id='.. data.chat_id_ ..'&user_id='.. users[2])
local Json_Info = JSON.decode(Chek_Info)
if Json_Info.result.can_change_info == true then
...
if Text and Text:match('change-ghjjgyy(%d+)/user@(%d+)/banusertrue') then
local users = {string.match(Text,"^change-ghjjgyy(%d+)/user@(%d+)/banusertrue$")}
if tonumber(users[1]) == tonumber(data.sender_user_id_) then
local Chek_Info = https.request('https://api.telegram.org/bot'..token..'/getChatMember?chat_id='.. data.chat_id_ ..'&user_id='.. users[2])
local Json_Info = JSON.decode(Chek_Info)
if Json_Info.result.can_change_info == true then
...
if Text and Text:match('change-ghjjgyy(%d+)/user@(%d+)/pinmsgtrue') then
local users = {string.match(Text,"^change-ghjjgyy(%d+)/user@(%d+)/pinmsgtrue$")}
if tonumber(users[1]) == tonumber(data.sender_user_id_) then
local Chek_Info = https.request('https://api.telegram.org/bot'..token..'/getChatMember?chat_id='.. data.chat_id_ ..'&user_id='.. users[2])
local Json_Info = JSON.decode(Chek_Info)
if Json_Info.result.can_change_info == true then
...
if Text and Text:match('change-ghjjgyy(%d+)/user@(%d+)/addlinktrue') then
local users = {string.match(Text,"^change-ghjjgyy(%d+)/user@(%d+)/addlinktrue$")}
if tonumber(users[1]) == tonumber(data.sender_user_id_) then
local Chek_Info = https.request('https://api.telegram.org/bot'..token..'/getChatMember?chat_id='.. data.chat_id_ ..'&user_id='.. users[2])
local Json_Info = JSON.decode(Chek_Info)
if Json_Info.result.can_change_info == true then
...
if Text and Text:match('change-ghjjgyy(%d+)/user@(%d+)/addadminfalse') then
local users = {string.match(Text,"^change-ghjjgyy(%d+)/user@(%d+)/addadminfalse$")}
if tonumber(users[1]) == tonumber(data.sender_user_id_) then
local Chek_Info = https.request('https://api.telegram.org/bot'..token..'/getChatMember?chat_id='.. data.chat_id_ ..'&user_id='.. users[2])
local Json_Info = JSON.decode(Chek_Info)
if Json_Info.result.can_change_info == true then
...
if Text and Text:match('change-ghjjgyy(%d+)/user@(%d+)/chenginfofalse') then
local users = {string.match(Text,"^change-ghjjgyy(%d+)/user@(%d+)/chenginfofalse$")}
if tonumber(users[1]) == tonumber(data.sender_user_id_) then
local Chek_Info = https.request('https://api.telegram.org/bot'..token..'/getChatMember?chat_id='.. data.chat_id_ ..'&user_id='.. users[2])
local Json_Info = JSON.decode(Chek_Info)
if Json_Info.result.can_change_info == true then
...
if Text and Text:match('change-ghjjgyy(%d+)/user@(%d+)/delmsggfalse') then
local users = {string.match(Text,"^change-ghjjgyy(%d+)/user@(%d+)/delmsggfalse$")}
if tonumber(users[1]) == tonumber(data.sender_user_id_) then
local Chek_Info = https.request('https://api.telegram.org/bot'..token..'/getChatMember?chat_id='.. data.chat_id_ ..'&user_id='.. users[2])
local Json_Info = JSON.decode(Chek_Info)
if Json_Info.result.can_change_info == true then
...
if Text and Text:match('change-ghjjgyy(%d+)/user@(%d+)/banuserfalse') then
local users = {string.match(Text,"^change-ghjjgyy(%d+)/user@(%d+)/banuserfalse$")}
if tonumber(users[1]) == tonumber(data.sender_user_id_) then
local Chek_Info = https.request('https://api.telegram.org/bot'..token..'/getChatMember?chat_id='.. data.chat_id_ ..'&user_id='.. users[2])
local Json_Info = JSON.decode(Chek_Info)
if Json_Info.result.can_change_info == true then
...
if Text and Text:match('change-ghjjgyy(%d+)/user@(%d+)/pinmsgfalse') then
local users = {string.match(Text,"^change-ghjjgyy(%d+)/user@(%d+)/pinmsgfalse$")}
if tonumber(users[1]) == tonumber(data.sender_user_id_) then
local Chek_Info = https.request('https://api.telegram.org/bot'..token..'/getChatMember?chat_id='.. data.chat_id_ ..'&user_id='.. users[2])
local Json_Info = JSON.decode(Chek_Info)
if Json_Info.result.can_change_info == true then
...
if Text and Text:match('change-ghjjgyy(%d+)/user@(%d+)/addlinkfalse') then
local users = {string.match(Text,"^change-ghjjgyy(%d+)/user@(%d+)/addlinkfalse$")}
if tonumber(users[1]) == tonumber(data.sender_user_id_) then
local Chek_Info = https.request('https://api.telegram.org/bot'..token..'/getChatMember?chat_id='.. data.chat_id_ ..'&user_id='.. users[2])
local Json_Info = JSON.decode(Chek_Info)
if Json_Info.result.can_change_info == true then
...
local Name_Bot = (bot_data:get(ban_id..'Name:Bot') or 'سسمموكر')
...
"صراحه  |  ااي رايك ف تيتو؟",
"صراحه  |  هل انت بتحب تيتو ؟",
...
--------------------------------------------------------------------------------------------------------------
V_I_K_I_N_G_3(data.message_,data)
